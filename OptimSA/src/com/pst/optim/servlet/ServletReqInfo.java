...
public class ServletReqInfo extends HttpServlet
{
    ...
    public static final String SCCS = "$Header: /users1/aa/cvsroot/com.ibm.optim.aa.siebel.dg.2.5.2/optimsa/java/com/pst/optim/servlet/ServletReqInfo.java,v 1.10 2009-06-29 18:46:32 ehan Exp $";
    protected String collection;
    protected boolean useODMCollection;
    protected boolean useOptimConnect;
    protected String result;
    
    public ServletReqInfo() {
    ...
    public void init() throws ServletException {
        super.init();
        this.log4 = Logger.getLogger((Class)ServletReqInfo.class);
        final Properties properties = new Properties();
        try {
            final InputStream resourceAsStream = this.getClass().getClassLoader().getResourceAsStream("optim.properties");
            if (resourceAsStream == null) {
                this.log4.error((Object)"Cannot load properties file from classpath.");
            }
        ...
        this.arcClass = properties.getProperty(this.initArcClass);
        ...
        if (this.arcClass == null || this.arcClass.trim().equals("")) {
            this.arcClass = "com.pst.optim.siebel.SiebelArc";
        }
    ...
    protected void processRequest(final HttpServletRequest httpServletRequest, final HttpServletResponse httpServletResponse) throws ServletException, IOException {
        this.log4.info((Object)"Incoming Request, processRequest");
        httpServletResponse.setContentType("text/xml;charset=UTF-8");
        final PrintWriter writer = httpServletResponse.getWriter();
        final ServletInputStream inputStream = httpServletRequest.getInputStream();
        try {
            this.sa = this.getSiebelArc((InputStream)inputStream, this.dsn, this.server, this.connectClass, this.collection, this.useODMCollection, this.useOptimConnect);
    ...
    public ArcReadable getSiebelArc(final InputStream inputStream, final String s, final String s2, final String s3, final String s4, final boolean b, final boolean b2) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
